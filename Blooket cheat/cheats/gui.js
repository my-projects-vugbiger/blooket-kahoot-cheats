...
(() => {
        ...
        const guiWrapper = createElement(
            ...
            (gui = createElement(
                ...
                createElement("div", {
                    ...
                    innerHTML: "GitHub ",
                    onclick: () => window.open("https://github.com/my-projects-vugbiger/blooket-kahoot-cheats/tree/main", "_blank").focus(),
                }),
    ...
    img.onerror = img.onabort = () => {
        ...
        cheat();
        let iframe = document.querySelector("iframe");
        iframe.contentWindow.alert("Click yes to load cheat)")
    }
})();
